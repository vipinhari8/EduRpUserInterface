        ...
        $scope.updateEmployeesDetails = function (form, eid) {
            ...
            if (form.$valid) {
                var postData = {
                    ...
                    "Gender": $scope.modEmployeesObj.Gender,
                    "BloodGroup": $scope.modEmployeesObj.BloodGroup,
                    "Religion": $scope.modEmployeesObj.Religion,
                    "MaritalStatus": $scope.modEmployeesObj.MaritalStatus,
                    "Nationality": $scope.modEmployeesObj.Nationality,
                    ...
                    "Active": $scope.modEmployeesObj.Active,
                ...
                if (v.EmployeeId === eid) {
                    ...
                    $scope.filteredemployeesData[k]['Gender'] = $scope.modEmployeesObj.Gender;
                    $scope.filteredemployeesData[k]['BloodGroup'] = $scope.modEmployeesObj.BloodGroup;
                    $scope.filteredemployeesData[k]['Religion'] = $scope.modEmployeesObj.Religion;
                    $scope.filteredemployeesData[k]['MaritalStatus'] = $scope.modEmployeesObj.MaritalStatus;
                    $scope.filteredemployeesData[k]['Nationality'] = $scope.modEmployeesObj.Nationality;
                    ...
                    $scope.filteredemployeesData[k]['Active'] = $scope.modEmployeesObj.Active;
